...
const firstLetters = (arr) => {
  // Solution code here...
  let newArry = arr.map((item)=> item.substring(0,1));
  return newArry;
};
...
const findHappiness = (arr) => {
  // Solution code here...
  let newArry = arr.filter(item => item.includes(':)'));
  return newArry;
};
...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  let newArray = arr.map((item)=> item.substring(1,4)+ item.substring(6,9) +item.substring(10,14));
  return newArray
};
...
const onlyOddChars = (str) => {
  // Solution code here...
  let newString = str.substring(1,2) + str.substring(3,4) + str.substring(5,6) + str.substring(7,8) + str.substring(9,10);
  return newString
};
